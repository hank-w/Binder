...
const Sidebar = (props) => {
  return (
    <div class="flex flex-col items-center w-16 h-screen overflow-hidden text-gray-400 bg-gray-900">
      <Link to="/" className="flex items-center justify-center mt-3">
        <MdSearch className=" w-6 h-6 stroke-current" />
      </Link>
      <div class="flex flex-col items-center mt-3 border-t border-gray-700">
        <SidebarLogo to="/" Icon={MdSearch} />
